...
---
## March
`26` {{ site.rw }} [The Reputation Tour](https://www.imdb.com/title/tt0780521/) {{ site.45 }}

`26` {{ site.rw }} [Tropico](https://www.imdb.com/title/tt0780521/) {{ site.4 }}

`26` [The Reputation Tour](https://www.imdb.com/title/tt0780521/) {{ site.25 }}

`25` [The Platform](https://www.imdb.com/title/tt0780521/) {{ site.r3 }}

`24` [Homecoming](https://www.imdb.com/title/tt0780521/) {{ site.r45 }}

`24` [Going Clear: Scientology and the Prison of Belief](https://www.imdb.com/title/tt0780521/) {{ site.r4 }}

`22` [Dear Zachary: A Letter to a Son About His Father](https://www.imdb.com/title/tt0780521/) {{ site.r5 }}

`22` [Ruby Ridge](https://www.imdb.com/title/tt0780521/) {{ site.r3 }}
