...
---
## December
Tolkien's Theology of Beauty, _Lisa Coutras_ {{ site.inprogress }}

`23` A Grief Observed, _C.S. Lewis_ {{ site.five }}

`15` Salò, or the 120 Days of Sodom, _Marquis de Sade_ {{ site.threehalf }}

`09` White American Youth, _Christian Picciolini_ {{ site.four }}
